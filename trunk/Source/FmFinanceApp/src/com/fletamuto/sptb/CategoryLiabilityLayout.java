...
public class CategoryLiabilityLayout extends CategoryBaseLayout {
    public void onCreate(Bundle savedInstanceState) {
        ...
        returnInputIncome.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(CategoryLiabilityLayout.this, InputIncomeLayout.class);
        ...
        runIncomeCategoryEdit.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(CategoryLiabilityLayout.this, CategoryIncomeEdit.class);
				startActivity(intent);
			}
        });        
