...
public class MainAssets2Layout extends FmBaseActivity {
	...
	private void setButtonClickListener() {
		...
		btnExpense.setOnClickListener(new View.OnClickListener() {
			...
			//	Intent intent = new Intent(MainAssetsLayout.this, SelectCategoryAssetsLayout.class);
				Intent intent = new Intent(MainAssets2Layout.this, ReportAssetsLayout.class);
		...
		btnIncome.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(MainAssets2Layout.this, ReportLiabilityLayout.class);
				startActivity(intent);
			}
		});
	}
