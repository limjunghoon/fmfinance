...
public class ReportLiabilityLayout extends ReportSeparationLayout {
    ...
    private void setListViewTextLoan(LiabilityLoanItem loan, View convertView) {
    	if (loan.getState() == FinanceItem.STATE_COMPLEATE) {

//    		ArrayList<Integer> incomeItemID = DBMgr.getIncomeFromAssets(loan.getID());
    		
    		((TextView)convertView.findViewById(R.id.TVSectionLine1Left)).setText(loan.getTitle());
    		((TextView)convertView.findViewById(R.id.TVSectionLine1Right)).setText(loan.getCategory().getName() + " (완료)");
    		
//    		if (incomeItemID.isEmpty())
//    		{
    			((TextView)convertView.findViewById(R.id.TVSectionLine2Left)).setText(String.format("%,d원", loan.getAmount()));
    			((TextView)convertView.findViewById(R.id.TVSectionLine2Right)).setText("이자 : 0원");
//    		} else {
...
//    			((TextView)convertView.findViewById(R.id.TVSectionLine2Right)).setText(String.format("이자 : %,d원", incomeItem.getAmount() - loan.getAmount()));
//    		}
    ...
    private void setListViewTextPersonLoan(LiabilityPersonLoanItem personLoan, View convertView) {
    	if (personLoan.getState() == FinanceItem.STATE_COMPLEATE) {

//    		ArrayList<Integer> incomeItemID = DBMgr.getIncomeFromAssets(personLoan.getID());
    		
    		((TextView)convertView.findViewById(R.id.TVSectionLine1Left)).setText(personLoan.getTitle());
    		((TextView)convertView.findViewById(R.id.TVSectionLine1Right)).setText(personLoan.getCategory().getName() + " (완료)");
    		
//    		if (incomeItemID.isEmpty())
//    		{
    			((TextView)convertView.findViewById(R.id.TVSectionLine2Left)).setText(String.format("%,d원", personLoan.getAmount()));
    			((TextView)convertView.findViewById(R.id.TVSectionLine2Right)).setText("이자 : 0원");
//    		} else {
//    			FinanceItem incomeItem = DBMgr.getItem(IncomeItem.TYPE,incomeItemID.get(0));
    			
//    			((TextView)convertView.findViewById(R.id.TVSectionLine2Left)).setText(String.format("%,d원", incomeItem.getAmount()));
//    			((TextView)convertView.findViewById(R.id.TVSectionLine2Right)).setText(String.format("이자 : %,d원", incomeItem.getAmount() - personLoan.getAmount()));
//    		}
    ...
    private void setListViewTextCashService(LiabilityCashServiceItem cashService, View convertView) {
    	if (cashService.getState() == FinanceItem.STATE_COMPLEATE) {

//    		ArrayList<Integer> incomeItemID = DBMgr.getIncomeFromAssets(cashService.getID());
    		
    		((TextView)convertView.findViewById(R.id.TVSectionLine1Left)).setText(cashService.getTitle());
    		((TextView)convertView.findViewById(R.id.TVSectionLine1Right)).setText(cashService.getCategory().getName() + " (완료)");
    		
//    		if (incomeItemID.isEmpty())
//    		{
    			((TextView)convertView.findViewById(R.id.TVSectionLine2Left)).setText(String.format("%,d원", cashService.getAmount()));
    			((TextView)convertView.findViewById(R.id.TVSectionLine2Right)).setText("이자 : 0원");
//    		} else {
//    			FinanceItem incomeItem = DBMgr.getItem(IncomeItem.TYPE,incomeItemID.get(0));
    			
//    			((TextView)convertView.findViewById(R.id.TVSectionLine2Left)).setText(String.format("%,d원", incomeItem.getAmount()));
//    			((TextView)convertView.findViewById(R.id.TVSectionLine2Right)).setText(String.format("이자 : %,d원", incomeItem.getAmount() - cashService.getAmount()));
//    		}
...
//    			((TextView)convertView.findViewById(R.id.TVSectionLine2Left)).setText(String.format("%,d원", incomeItem.getAmount()));
//    			((TextView)convertView.findViewById(R.id.TVSectionLine2Right)).setText(String.format("이자 : %,d원", incomeItem.getAmount() - item.getAmount()));
//    		}
