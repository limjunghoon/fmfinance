...
//		updateStateChangeItem(item);
	...
	public ArrayList<FinanceItem> getItemsFromCategoryID(int mainCategoryID, int year) {
		...
		queryBilder.setTables("assets, assets_main_category");
		queryBilder.appendWhere("assets.main_category=assets_main_category._id");
		Cursor c = queryBilder.query(db, null, "strftime('%Y', create_date)=? AND assets.main_category=?", params, null, null, null);
	...
	public Category getSubCategoryFromID(int categoryID) {
		...
		Cursor c = db.query("assets_sub_category", null, "_id=?", new String[]{String.valueOf(categoryID)}, null, null, null);
